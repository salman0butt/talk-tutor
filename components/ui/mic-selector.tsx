...
export function MicSelector({
  ...
  const selectedDevice = isControlled
    ? value
    : internalSelectedDevice || defaultDeviceId

  // Notify controlled consumers when the first available device becomes the default.
  useEffect(() => {
